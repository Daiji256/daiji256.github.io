...
publishedDate: 2021-12-03T00:00:00+09:00
...
魚眼カメラで撮影した等距離射影方式の画像を、普通のカメラの中心射影方式への変換をするなどの、画像を幾何学的変換することがあります。僕は研究で、中央付近を大きく、外側を小さくする変換をするために使いました。
...
5--10行目では、変換前後画素の関係を計算しています。計算式については説明を省きます。
