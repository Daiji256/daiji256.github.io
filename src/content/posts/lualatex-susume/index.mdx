---
title: 'LuaLaTeXのすゝめ'
description: 'LaTeXの中でも、高性能でイケイケなLuaLaTeXを紹介します。LuaLaTeXの何が良いか、どうやってLuaLaTeXに乗り換えを行うかを説明します。'
publishedDate: 2021-02-07T00:00:00+09:00
...
この記事では**高性能でイケイケ**なLuaLaTeXを紹介します。
...
あらかじめ用意された和文フォントから選択することができる`luatexja-preset`というパッケージがあります。たとえばIPA明朝とIPAゴシックを使う設定にする場合次のように書けばよいです。他のフォントについては[LaTeX-jaの使い方](https://ja.osdn.net/projects/luatex-ja/wiki/LuaTeX-ja%E3%81%AE%E4%BD%BF%E3%81%84%E6%96%B9)を参照してください。
