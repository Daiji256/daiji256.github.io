...
description: 'LuaLaTeXはフォントを扱うことが容易という強みを持っています。この強みを活かして、実質的にMS Wordでの作成を要求された場合においても、LaTeXを使用できます。LuaLaTeXでフォントを変更する方法を紹介します。'
publishedDate: 2021-02-02T00:00:00+09:00
