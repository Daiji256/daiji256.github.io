...
{/* TODO: 圧縮回避のためにrgb-cmyにファイルを配置している、できれば修正したい */}
<img src="/rgb-cmy/rgb.png" alt="#FF0000、#00FF00、#0000FFが交互に配置された画像" width="256" />
...
{/* TODO: 圧縮回避のためにrgb-cmyにファイルを配置している、できれば修正したい */}
<img src="/rgb-cmy/cmy.png" alt="#00FFFF、#FF00FF、#FFFF00が交互に配置された画像" width="256" />
