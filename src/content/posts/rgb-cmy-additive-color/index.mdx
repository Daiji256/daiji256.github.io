...
奥村先生の解説は[加法混色と減法混色](https://okumuralab.org/~okumura/cs/color_mixture.html)にあるので、ここでは色覚的な観点から簡単に解説します。ちなみに僕は色について素人です。
...
これを暗い部屋で確認したところ、白色に見えました。一般的なRGBカメラで撮影した[^pixel-9-pro]場合でも白色になりました。加法混色により白色になることを実感できました。
